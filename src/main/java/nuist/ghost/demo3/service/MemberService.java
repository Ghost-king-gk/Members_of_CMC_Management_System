...
public class MemberService {
    ...
    public Member createMember(CreateMemberRequest request) {
        ...
        Member member = switch (memberType) {
            case "RegularMember", "regular", "REGULAR" -> new RegularMember(request.name(), request.studentID());
            case "SectionHead", "sectionhead", "SECTION_HEAD" -> new SectionHead(request.name(), request.studentID());
            case "President", "president", "PRESIDENT" -> new President(request.name(), request.studentID());
